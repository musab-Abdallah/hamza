...
// nav menu start
// الحصول على عناصر القائمة والأزرار
// const menuToggle = document.getElementById("menu-togglee");
const navMenu = document.getElementById("nav-menuu");
const navLinks = document.querySelectorAll(".nav-menuu a");

// تفعيل/إلغاء تفعيل القائمة عند النقر على زر القائمة
